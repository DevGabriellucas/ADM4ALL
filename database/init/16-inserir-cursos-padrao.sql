...
--
-- A coordenacao pode editar, excluir ou acrescentar cursos pela interface. O
-- status nao entra aqui porque e derivado das turmas do curso na consulta.
-- O ON CONFLICT (nome) evita duplicar caso o script rode de novo.

INSERT INTO treinamentos (id, nome, descricao, carga_horaria, periodo_letivo)
VALUES
    (
