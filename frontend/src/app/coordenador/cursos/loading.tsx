...
const COURSE_ROW_SKELETONS = ["curso-1", "curso-2", "curso-3"] as const;

export default function CoordinatorCoursesLoading() {
  return (
    <div aria-busy="true" className="animate-pulse space-y-6">
      ...
      <section className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
        {COURSE_CARD_SKELETONS.map((card) => (
