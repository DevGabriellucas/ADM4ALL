...
export const CoordinatorSidebar = () => {
  ...
  return (
    <aside className="flex w-full flex-col gap-y-8 bg-brand-medium px-6 py-8 text-slate-950 lg:min-h-screen lg:w-64 lg:shrink-0">
      ...
      >
        ...
        <button
          type="button"
          onClick={logout}
          className="mt-2 flex items-center gap-x-2 rounded-md px-3 py-2 text-left font-semibold text-[#8F1D2C] text-sm tracking-[0.15em] transition-colors hover:bg-red-100/70"
        >
          <svg
            aria-hidden
            viewBox="0 0 24 24"
