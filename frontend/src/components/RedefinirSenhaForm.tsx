...
export const RedefinirSenhaForm = ({ token }: RedefinirSenhaFormProps) => {
  ...
  return (
    <main className="flex min-h-screen w-full flex-col items-center justify-center gap-y-24 bg-[#E0F0FF] bg-[url(/adm-para-todos-logo.png)] bg-center bg-no-repeat px-4">
        ...
        >
          <div className="relative w-full md:w-[75%] xl:w-220">
            <Input
              id="novaSenha"
              label="Nova senha"
              className="mt-4 w-full bg-[#B6AEAE] px-6 py-3 pr-20 text-xl opacity-60 outline-none placeholder:font-normal placeholder:text-[#454040] placeholder:text-xl autofill:shadow-[inset_0_0_0_1000px_#B6AEAE]"
            ...
            <button
              type="button"
              className="-translate-y-1/2 absolute top-[3.61rem] right-6 flex size-10 cursor-pointer items-center justify-center rounded text-slate-700 hover:text-slate-950 focus-visible:outline-2 focus-visible:outline-brand-medium disabled:pointer-events-none disabled:opacity-50"
              aria-controls="novaSenha"
              ...
              disabled={isSuccess}
              onClick={() => setShowNovaSenha((visible) => !visible)}
            >
              {renderEyeIcon(showNovaSenha)}
            </button>
          </div>
          ...
          <div className="relative w-full md:w-[75%] xl:w-220">
            ...
            <button
              ...
              disabled={isSuccess}
              onClick={() => setShowConfirmarSenha((visible) => !visible)}
            >
              {renderEyeIcon(showConfirmarSenha)}
            </button>
          </div>
